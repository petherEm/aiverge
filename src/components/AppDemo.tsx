...
const prices = [
  500, 550, 530, 570, 580, 590, 600, 650, 700, 750, 800, 850, 900, 950, 1000,
]
    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}-gradient`} x1="0" x2="0" y1="0" y2="1">
          <stop offset="0%" stopColor="#d406cd" />
          <stop offset="100%" stopColor="#d406cd" stopOpacity="0" />
        </linearGradient>
      </defs>
      ...
      <motion.path
        ...
        {...(isInView ? { stroke: '#d406cd', animate: { pathLength: 1 } } : {})}
        onUpdate={({ pathLength }) => {
      ...
      <AppScreen.Body>
        <div className="p-4">
          <div className="flex gap-2">
            <div className="text-md font-bold leading-6 text-gray-500">
              AI bubble chart
            </div>
          ...
          <div className="mt-3 border-t border-gray-200 pt-5">
            <div className="flex items-baseline gap-2">
              ...
              <div className="text-sm text-gray-900">M USD</div>
              {percentageChange && (
                <div
                  className={clsx(
            ...
            <div className="mt-6 flex gap-4 text-xs text-gray-500">
              ...
              <div>1M</div>
              <div>6M</div>
              <div className="font-semibold text-[#d406cd]">1Y</div>
              <div>5Y</div>
            </div>
            ...
            <div className="mt-4 rounded-lg bg-[#d406cd] px-4 py-2 text-center text-sm font-semibold text-white">
              Trade
            </div>
